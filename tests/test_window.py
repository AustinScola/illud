...
@pytest.mark.parametrize('window, canvas, expected_canvas_after', [
    ...
    (Window(size=IntegerSize2D(1, 1)), Canvas(IntegerSize2D(1, 1)).fill('x'), Canvas(IntegerSize2D(1, 1), [[' ']])),
    (Window(size=IntegerSize2D(1, 1), buffer_=Buffer('a')), Canvas(IntegerSize2D(1, 1)).fill('x'), Canvas(IntegerSize2D(1, 1), [['a']])),
    (Window(size=IntegerSize2D(2, 1), buffer_=Buffer('foo')), Canvas(IntegerSize2D(2, 1)).fill('x'), Canvas(IntegerSize2D(2, 1), [['f', 'o']])),
    (Window(size=IntegerSize2D(3, 1), buffer_=Buffer('foo')), Canvas(IntegerSize2D(3, 1)).fill('x'), Canvas(IntegerSize2D(3, 1), [['f', 'o', 'o']])),
    (Window(size=IntegerSize2D(2, 1), buffer_=Buffer('foo')), Canvas(IntegerSize2D(3, 1)).fill('x'), Canvas(IntegerSize2D(3, 1), [['f', 'o', 'x']])),
    (Window(size=IntegerSize2D(3, 1), buffer_=Buffer('foo')), Canvas(IntegerSize2D(4, 1)).fill('x'), Canvas(IntegerSize2D(4, 1), [['f', 'o', 'o', 'x']])),
    (Window(size=IntegerSize2D(3, 1), buffer_=Buffer('foo')), Canvas(IntegerSize2D(5, 1)).fill('x'), Canvas(IntegerSize2D(5, 1), [['f', 'o', 'o', 'x', 'x']])),
    (Window(size=IntegerSize2D(5, 1), buffer_=Buffer('foo')), Canvas(IntegerSize2D(5, 1)).fill('x'), Canvas(IntegerSize2D(5, 1), [['f', 'o', 'o', ' ', ' ']])),
    (Window(size=IntegerSize2D(5, 1), buffer_=Buffer('foo\n')), Canvas(IntegerSize2D(5, 1)).fill('x'), Canvas(IntegerSize2D(5, 1), [['f', 'o', 'o', ' ', ' ']])),
    (Window(size=IntegerSize2D(2, 2), buffer_=Buffer('foo')), Canvas(IntegerSize2D(3, 2)).fill('x'), Canvas(IntegerSize2D(3, 2), [['f', 'o', 'x'], [' ', ' ', 'x']])),
    (Window(size=IntegerSize2D(1, 2), buffer_=Buffer('f')), Canvas(IntegerSize2D(2, 2)).fill('x'), Canvas(IntegerSize2D(2, 2), [['f', 'x'], [' ', 'x']])),
    (Window(size=IntegerSize2D(1, 2), buffer_=Buffer('f\nb')), Canvas(IntegerSize2D(2, 2)).fill('x'), Canvas(IntegerSize2D(2, 2), [['f', 'x'], ['b', 'x']])),
    (Window(size=IntegerSize2D(1, 2), buffer_=Buffer('foo\nb')), Canvas(IntegerSize2D(2, 2)).fill('x'), Canvas(IntegerSize2D(2, 2), [['f', 'x'], ['b', 'x']])),
    (Window(size=IntegerSize2D(1, 2), buffer_=Buffer('foo\nbar')), Canvas(IntegerSize2D(2, 2)).fill('x'), Canvas(IntegerSize2D(2, 2), [['f', 'x'], ['b', 'x']])),
